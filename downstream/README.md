...
Contains subdirectories with input data used for the analyses. The input data from sections 1-6 was obtained from the generation of accelerated elements, outlined in: <https://github.com/paulati/ncomms-24-47757/tree/main/accelerated_elements>.
